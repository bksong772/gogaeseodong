...
export const metadata: Metadata = {
  title: "서동여관 그림의방 이용 메뉴얼 | 고개서동",
  description: "서동여관 그림의방 이용 안내. 체크인/체크아웃, 비밀번호, 빔 프로젝터, 턴테이블, 퇴실 방법.",
};
...
export default function GeurimManualPage() {
  return (
    <div className="pt-16">
      {/* ── 히어로 ─────────────────────────────────────── */}
      <div
      ...
      <div className="max-w-2xl mx-auto px-6 sm:px-8 pt-6">
        <div className="rounded-xl px-5 py-4 mb-3"
          ...
          <p className="text-sm font-semibold mb-1" style={{ color: "#2C1810" }}>📽️ 그림의방에는 빔 프로젝터가 있습니다</p>
          <p className="text-xs leading-5" style={{ color: "#6B4C3B" }}>
            스마트폰 미러링으로 영상 시청이 가능해요. 작은 태블릿도 비치되어 있습니다.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-6 sm:px-8 py-8 space-y-10">
        ...
        <Block icon={Key} title="비밀번호 · 출입 방법">
          ...
          <div className="text-sm space-y-2" style={{ color: "#2C1810" }}>
            ...
            <p style={{ lineHeight: "1.9" }}>
              부산 금정구 서동로91번길 7, <strong>4층</strong><br />
              <span style={{ color: "#9B7B6A" }}>1층이 하얀 커튼으로 쳐진 집이에요.</span><br />
              <strong style={{ color: "#B5632A" }}>빨간 대문</strong>으로 올라오셔서
              계단을 따라 <strong style={{ color: "#B5632A" }}>4층 끝까지</strong> 오시면 파란 대문이 그림의방입니다.<br />
              <span style={{ color: "#9B7B6A" }}>숫자 4가 적힌 파란 대문이 그림의방이에요.</span><br />
        ...
        <Block icon={Package} title="비치물품">
          <div className="space-y-4">
            ...
            <div className="rounded-xl p-4" style={{ backgroundColor: "#FFF8F0", border: "1px solid rgba(181, 99, 42, 0.3)" }}>
              <p className="section-label" style={{ fontSize: "10px", marginBottom: "10px" }}>그림의방 전용</p>
              <div className="space-y-1.5 text-sm" style={{ color: "#2C1810" }}>
                <p>🛏️ 퀸 침대 (안방) + 다락방 쇼파베드</p>
                <p style={{ color: "#9B7B6A", fontSize: "12px" }}>다락방 수납장에 쇼파베드용 침구(베개·이불)가 있어요.</p>
        ...
        <div id="checkout">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              { num: "1", label: "전체 소등", sub: "방·부엌·다락방·화장실" },
