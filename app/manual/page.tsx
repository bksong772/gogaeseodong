    ...
    <div className="pt-16">
      ...
      <div className="max-w-2xl mx-auto px-6 sm:px-8 pt-6">
        <a
          ...
          style={{
            ...
            border: "1px solid rgba(181, 99, 42, 0.35)",
            textDecoration: "none",
          }}
        >
          <span className="text-sm font-semibold" style={{ color: "#B5632A" }}>
            퇴실 전 확인사항
          </span>
      ...
      <div className="max-w-2xl mx-auto px-6 sm:px-8 py-8 space-y-10">
        ...
        <Block icon={Key} title="비밀번호 · 출입 방법">
          ...
          >
            <p className="section-label" style={{ fontSize: "10px", marginBottom: "6px" }}>
              📌 비밀번호 안내
            </p>
            <p
            ...
            <p className="text-xs mt-2" style={{ color: "#9B7B6A" }}>
              ...
              {" "}또는{" "}
              <a href="tel:01035484572" style={{ color: "#B5632A" }}>
                010-3548-4572
              </a>
              {" "}로 연락 주세요
            </p>
          ...
          <div className="space-y-2">
            {[
              ...
              <div
                ...
                style={{
                  backgroundColor: wifi.best ? "#FFF8F0" : "#F0E8D5",
                  border: wifi.best ? "1px solid rgba(181, 99, 42, 0.5)" : "1px solid rgba(196, 168, 130, 0.4)",
                }}
              >
                <div>
        ...
        <Block icon={MapPin} title="찾아오는 길">
          <div className="space-y-4 text-sm" style={{ color: "#2C1810" }}>
            ...
            <div style={{ borderTop: "1px solid rgba(196, 168, 130, 0.3)", paddingTop: "14px" }}>
              <a
                href="https://m.blog.naver.com/bksong77/222609333636"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <Block icon={Lightbulb} title="전등 스위치">
          <div className="space-y-2 text-sm" style={{ color: "#2C1810" }}>
            ...
            <p className="font-semibold" style={{ color: "#B5632A" }}>
              퇴실 시 전체 소등 꼭 부탁드립니다.
            </p>
          </div>
        </Block>
        ...
        <Block icon={Zap} title="전열기기 사용법">
          <div className="space-y-4">
            ...
            >
              ...
              <div className="space-y-2">
                <a
                  href="https://youtu.be/TC9orz3WzxY"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm"
                  style={{ color: "#B5632A" }}
                ...
                <a
                  href="https://youtu.be/G9Lox8uUbw0"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm"
                  style={{ color: "#B5632A" }}
            ...
            >
              ...
              <a
                href="https://youtu.be/poxqBy9y0mM"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm"
                style={{ color: "#B5632A" }}
        ...
        <Block icon={Package} title="냉장고 이용">
          <div className="space-y-3 text-sm">
            ...
            >
              <p className="font-semibold mb-1" style={{ color: "#B52A2A" }}>
                우측 냉장고 — 정기이용자 전용
              </p>
              <p style={{ color: "#6B4C3B" }}>
                정기이용자 개인 물품이 보관되어 있으니 사용하지 않도록 해주세요.
              </p>
            </div>
          </div>
        </Block>
        ...
        <Block icon={Utensils} title="조리도구 · 비품">
          ...
          <div className="rounded-xl overflow-hidden mt-4" style={{ border: "1px solid rgba(196, 168, 130, 0.4)" }}>
            <Image
              src="/manual/각종 양념류.JPG"
              alt="기본 양념류"
              width={600}
              height={400}
              className="w-full object-cover"
            />
            <p className="text-xs text-center py-2" style={{ color: "#9B7B6A", backgroundColor: "#F0E8D5" }}>기본 양념류 (소금·설탕·후추·간장·식용유·참기름·식초 등)</p>
          </div>
        </Block>
          ...
          <div className="space-y-3 text-sm" style={{ color: "#2C1810" }}>
            <p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#B5632A", fontWeight: 600 }}
              >
                &lsquo;고개서동&rsquo;
              </a>
              {" "}으로 친구추가 후 문의해주세요.
            ...
            <p>
              급한 문의:{" "}
              <a href="tel:01035484572" style={{ color: "#B5632A", fontWeight: 600 }}>
                010-3548-4572
              </a>
            </p>
          </div>
        ...
        <div id="checkout">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div
              className="col-span-2 rounded-xl p-4 flex items-center gap-3"
              style={{ backgroundColor: "#FFF8F0", border: "1px solid rgba(181, 99, 42, 0.3)" }}
            >
              <span
                style={{
        ...
        <div>
          ...
          <div className="card p-5 sm:p-6" style={{ backgroundColor: "#F0E8D5" }}>
            ...
            <p className="text-xs" style={{ color: "#9B7B6A" }}>
              리뷰 작성 전에 미리 알려주시면 더 챙겨드릴 수 있어요.
            </p>
          </div>
        </div>
        ...
        >
          <p
            className="text-sm"
            style={{ color: "#9B7B6A", fontFamily: "'Noto Serif KR', serif" }}
          >
            편안하고 즐거운 시간 되세요 ♡
          </p>
