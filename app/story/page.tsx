        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          ...
          >
            ...
            <p>
              ...
              매번 맛있는 음식을 나눠주던 동네 아줌마가 알고 보니 사기꾼이었던 적도 있어요.
              곗돈 떼였던 이야기를 많이 들어서, 저는 지금도 계는 하지 않습니다.
              이 동네는 매주 싸움이 일어났어요. 다들 이렇게 사는 줄 알았습니다.
            </p>

            <p>
              필사의방 3층엔 이웃 가족이 살았어요.
              신혼부터 살았는데 부부싸움이 너무 심했거든요.
              저는 결혼하면 다 그런 줄 알았습니다. 커서 보니 아니더라고요.
            </p>
            ...
            <p style={{ color: "#9B7B6A" }}>
              타지에서 살다 보면 가끔 계단 소리가 생각났습니다.
              이 동네 아무것도 아닌 것들이 자꾸 생각났어요.
            </p>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 sm:px-8">
          <div className="mb-16" style={{ maxWidth: "640px" }}>
            ...
            >
              그래서 이걸 하기로 했습니다. 공간이 낡은 만큼, 나머지를 직접 채우기로요.
            </p>
          </div>
